...
public class FaceRelativeLayout extends RelativeLayout implements OnItemClickListener, OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.et_sendmessage:
			 ...
			 * = et_sendmessage.getText().toString(); if(!(text.length()>0)){
			 * //Toast.makeText(MainActivity.this,mEditTextContent.getText()+
			 * "请输入聊天内容", 2).show(); btn_photo.setVisibility(View.VISIBLE);
			 * mBtnSend.setVisibility(View.GONE); }else{
			 * //Toast.makeText(MainActivity.this,"输入的聊天内容为："+mEditTextContent.
			 * getText(), 2).show(); btn_photo.setVisibility(View.GONE);
			 * mBtnSend.setVisibility(View.VISIBLE); } }
			 * 
			 * @Override public void onTextChanged(CharSequence s, int arg1, int
			 * arg2, int arg3) { }
			 * 
			 * @Override public void beforeTextChanged(CharSequence s, int arg1,
			 * int arg2, int arg3) { } }); // 隐藏表情选择框 if (view.getVisibility()
			 * == View.VISIBLE) { view.setVisibility(View.GONE); }
			 */
			// 隐藏更多操作选择框
			/*
			 * if (moreChoose.getVisibility() == View.VISIBLE) {
