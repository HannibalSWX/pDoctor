...
/**
 * @Title:PhonePriceActivity.java
 * @Description:应用PhonePriceActivity.java类
 * @Author:owen
 * @Since:2015年7月15日
 * @Version:
 */
public class PhonePriceActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext = this;
		setContentView(R.layout.activity_phoneprice);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case RESULT_OK:
			...
			tv_time_price.setText(price + "元/次");
			break;
		default:
			break;
		}
