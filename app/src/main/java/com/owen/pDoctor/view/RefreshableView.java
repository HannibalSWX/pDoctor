...
public class RefreshableView extends LinearLayout {
 ...
 //   private Long refreshTime = null;
    ...
    private void init() {
        ...
        downTextString = mContext.getResources().getString(R.string.pull_to_refresh);
        releaseTextString = mContext.getResources().getString(R.string.release_to_refresh);   
    }
...
//        }
        ...
        if(lp.topMargin >  0){
            ...
            refreshIndicatorView.setImageResource(R.drawable.pull_to_refresh_arrow);
        }else{
