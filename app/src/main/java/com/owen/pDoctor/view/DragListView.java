...
public class DragListView extends ListView implements OnScrollListener,
	...
	private boolean mIsHistoryAttendance = false;
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		// Log.i("T**********T", "firstVisibleItem=" + firstVisibleItem +
		// "\nvisibleItemCount=" + visibleItemCount
		// + "\ntotalItemCount" + totalItemCount);
		if (visibleItemCount == totalItemCount && !mIsHistoryAttendance) {// 不满一屏时不显示footView
			if (isFootViewExist) {
	...
	public void setmIsHistoryAttendance(boolean mIsHistoryAttendance) {
		this.mIsHistoryAttendance = mIsHistoryAttendance;
	}
