...
public class PullToRefreshView2 extends LinearLayout {
	...
	public void setRefreshTime(String time) {
		mHeaderUpdateTextView.setText(time);
	}

	/**
	 * init AdapterView like ListView,GridView and so on;or init ScrollView
	 * 
	 * @description zq 2012-7-30下午8:48:12
	 */
	...
	private boolean isRefreshViewScroll(int deltaY) {
		...
		if (mAdapterView != null) {
			...
			if (deltaY > 20) { // 设置滚动间距大点，防止影响listview和gridview点击事件
		...
		if (mScrollView != null) {
			...
			// 设置滚动间距大点，防止影响listview和gridview点击事件
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderImageView.setImageResource(R.drawable.pull_to_refresh_arrow);
		mHeaderTextView.setText(R.string.pull_to_refresh);
	...
	// * lock
	// *
	// * @description zq 2012-7-27下午6:52:25
	// */
	// private void lock() {
	// mLock = true;
	// }
	...
	// * unlock
	// *
	// * @description zq 2012-7-27下午6:53:18
	// */
	// private void unlock() {
	// mLock = false;
	// }
