package com.owen.pDoctor.alipay;
...
public class AliPayActivity extends FragmentActivity {
	...
	private String tittle, oid, totalPrice, partner, rsa_private, sign, _input_charset, notify_url, out_trade_no, subject, payment_type, seller_id, total_fee, body;
			...
			case SDK_PAY_FLAG: {
				...
				if (TextUtils.equals(resultStatus, "9000")) {
					...
					if (TextUtils.equals(resultStatus, "8000")) {
						...
						Toast.makeText(AliPayActivity.this, resultMsg, Toast.LENGTH_SHORT).show();
					} else {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		rsa_private = intent.getStringExtra("rsa_private");
		sign = intent.getStringExtra("sign");
		_input_charset = intent.getStringExtra("_input_charset");
	...
	private void initview() {
		...
		product_description.setText(body);
		product_price.setText(total_fee);
	...
	public void pay(View v) {
		// 订单
		String orderInfo = getOrderInfo(tittle, body, total_fee);
